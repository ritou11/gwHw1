...
%% Modify LDU - Local Re
[Lm2, Dm2, Um2] = modifyLDUr1(L, D, U, Ml, -ybr);
[Lm2, Dm2, Um2] = modifyLDUr1(Lm2, Dm2, Um2, sparse(fbn, 1, 1, N, 1), -1j * bbn);
[Lm2, Dm2, Um2] = modifyLDUr1(Lm2, Dm2, Um2, sparse(tbn, 1, 1, N, 1), -1j * bbn);
